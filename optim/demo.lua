...
local learningRates = function (data,lamb)
   ...
   for i = 1,data:size() do
	   H = H + data[i][1]*data[i][1]/data:size()*2
   end
   --regularizor
   H = H + 2*lamb/config.batchSize;
   -- Delete the following line and add your stuff
   print("You must implement this function by yourself!")
end
